 ...
 * @author gamba
 */
public class AñadirTareasController implements Initializable {
    ...
    private void CambiarAyuda() throws IOException {
        App.setRoot("Ayuda");
           ...
           @FXML
     private void popAñadida() {
       App.mostrarInformacion("Añadir tarea", "Tarea añadida con exito");
    }
     
                    @FXML
     private void popAyuda() {
       App.mostrarInformacion("Ayuda", "En esta ventana podras añadir nuevas tareas completando los campos y pulsando el boton para añadir");
    }
}
