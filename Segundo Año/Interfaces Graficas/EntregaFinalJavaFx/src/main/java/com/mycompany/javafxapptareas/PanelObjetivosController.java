 ...
 * @author gamba
 */
public class PanelObjetivosController implements Initializable {
    ...
    private void CambiarAyuda() throws IOException {
        App.setRoot("Ayuda");
                   ...
                   @FXML
     private void popCambiarObjetivo() {
       App.mostrarInformacion("Objetivos", "Tus objetivos cambiaron!");
    }
                        @FXML
     private void popAyuda() {
       App.mostrarInformacion("Ayuda", "En esta ventana puedes ver y cambiar tus objetivos!");
    }
}
