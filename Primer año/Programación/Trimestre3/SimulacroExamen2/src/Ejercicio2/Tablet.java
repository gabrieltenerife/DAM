...
public class Tablet extends Productos{
	...
	public Tablet(double precio, String modelo, String marca, int memoria, double descuento) {
		super(precio);
		this.modelo = modelo;
		this.marca = marca;
	...
	public static boolean equals (Tablet a, Tablet b) {
	...
	public String toString() {
		return "La tablet: " +modelo+ " de la marca " +marca+ " con una memoria de " +memoria+ " gigabites tiene un precio de " +precio+
