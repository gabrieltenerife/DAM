...
public class Telefonomovil extends Producto{
	...
	public Telefonomovil(double precio, String modelo, String marca, int memoria, int descuento) {
		super(precio);
		this.modelo = modelo;
		this.marca = marca;
	...
	public static boolean equals (Telefonomovil t, Telefonomovil t1) {
	...
	public String toString() {
		return "Telefonomovil [modelo=" + modelo + ", marca=" + marca + ", memoria=" + memoria + ", precio=" + precio
				+ ", descuento=" + descuento + "]";
	}
