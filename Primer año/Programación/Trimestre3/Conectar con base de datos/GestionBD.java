...
public class GestionBD {
	...
	private ResultSet resultado; // ALMACENA EL RESULTADO OBTENIDO DE LA CONSULTA A LA BASE DE DATOS
	...
	public boolean insertarProfesor(String dni, String nombre, String apellidos, String direccion, String pass)
			throws SQLException {
		boolean insertado = false;
		con = conexion.getConexion();
		String sql = "insert into profesores (DNI,NOMBRE,APELLIDOS,DIRECCION,PASSWORD) values ('" + dni + "','" + nombre
				+ "','" + apellidos + "','" + direccion + "','" + pass + "')";
		try {
	...
	public boolean insertarCiclo(String codigo, String nombre, String familia, String titulacion, String horas)
			throws SQLException {
		boolean insertado = false;
		con = conexion.getConexion();
		String sql = "insert into ciclosformativos (CODIGO,NOMBRE,FAMILIA,TITULACION,HORAS) values ('" + codigo + "','"
				+ nombre + "','" + familia + "','" + titulacion + "','" + horas + "')";
		try {
			st = (Statement) con.createStatement();
			int confirmar = st.executeUpdate(sql);
			if (confirmar == 1) {
	...
	public boolean insertarModulo(String clave, String ciclo, String denominacion, String horasc, String curso,
			String horass) throws SQLException {
		boolean insertado = false;
		con = conexion.getConexion();
		String sql = "insert into modulos (CLAVE,CICLO,DENOMINACION,HORASC,CURSO,HORASS) values ('" + clave + "','"
				+ ciclo + "','" + denominacion + "','" + horasc + "','" + curso + "','" + horass + "')";
		try {
			st = (Statement) con.createStatement();
			int confirmar = st.executeUpdate(sql);
			if (confirmar == 1) {
	...
	public int modificarProfesor(String dni, String nombre, String apellidos, String direccion, String pass)
			throws SQLException {
		int confirmar = 0;
		con = conexion.getConexion();
		String sql = "update profesores set DNI='" + dni + "', NOMBRE='" + nombre + "', APELLIDOS='" + apellidos
				+ "', DIRECCION='" + direccion + "', PASSWORD='" + pass + "' where DNI=" + dni + "";
		try {
			st = (Statement) con.createStatement();
			confirmar = st.executeUpdate(sql);
	...
	public int modificarCiclo(String codigo, String nombre, String familia, String titulacion, String horas)
			throws SQLException {
		int confirmar = 0;
		con = conexion.getConexion();
		String sql = "update ciclosformativos set CODIGO='" + codigo + "', NOMBRE='" + nombre + "', FAMILIA='" + familia
				+ "', TITULACION='" + titulacion + "', HORAS='" + horas + "' where CODIGO=" + codigo + "";
		try {
			st = (Statement) con.createStatement();
			confirmar = st.executeUpdate(sql);
			st.close();
	...
	public int modificarModulo(String clave, String ciclo, String denominacion, String horasc, String curso,
			String horass) throws SQLException {
		int confirmar = 0;
		con = conexion.getConexion();
		String sql = "update modulos set CLAVE='" + clave + "', CICLO='" + ciclo + "', DENOMINACION='" + denominacion
				+ "', HORASC='" + horasc + "', CURSO='" + curso + "', HORASS='" + horass + "' where CLAVE=" + clave
				+ "";
		try {
			st = (Statement) con.createStatement();
			confirmar = st.executeUpdate(sql);
